...
class Marketplace extends \Opencart\System\Engine\Controller {
	...
	public function getList(): string {
		...
		$results = glob(DIR_EXTENSION . '*/controller/marketplace/*.php');
	...
	public function install(): void {
		...
		if (!is_file(DIR_EXTENSION . $extension . '/controller/marketplace/' . $code . '.php')) {
		...
		if (!$json) {
			...
			$this->autoloader->register('Opencart\Admin\Controller\Extension\\' . $namespace, DIR_EXTENSION . $extension . '/controller/');
			$this->autoloader->register('Opencart\Admin\Model\Extension\\' . $namespace, DIR_EXTENSION . $extension . '/model/');
			$this->autoloader->register('Opencart\System\Extension\\' . $namespace, DIR_EXTENSION . $extension . '/system/');

			// Template directory
			$this->template->addPath('extension/' . $extension, DIR_EXTENSION . $extension . '/view/template/');

			// Language directory
			$this->language->addPath('extension/' . $extension, DIR_EXTENSION . $extension . '/language/');
